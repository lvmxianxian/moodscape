...
export default function VibeListDetailPage() {
  ...
  const canCreateRoute = places.length > 0;
            ...
            <div className="mt-6 grid gap-3 sm:grid-cols-2">
              {canCreateRoute ? (
                ...
                <button
                  type="button"
                  disabled
                  className="rounded-full bg-[#F1F1EE] px-6 py-4 text-sm font-bold text-[#7A7A73] disabled:cursor-not-allowed"
                >
                  Aggiungi luoghi per creare percorso
                </button>
              )}
